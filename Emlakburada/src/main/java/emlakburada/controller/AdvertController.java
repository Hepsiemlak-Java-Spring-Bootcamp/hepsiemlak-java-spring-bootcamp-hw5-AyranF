...
public class AdvertController {
	...
	public ResponseEntity<AdvertResponse> createAdvert(@RequestBody Object request) throws Exception {
		return new ResponseEntity<>(advertService.saveAdvert(AdvertRequest.convertRequest(request)), HttpStatus.CREATED);
	}
